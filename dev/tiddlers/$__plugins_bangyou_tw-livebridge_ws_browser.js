...
(function () {
    ...
    async function scrollToElementByOffset(title, offset) {
        ...
        while (attempts < maxAttempts) {
            ...
            // Find the tiddler body element
            const bodyElement = tiddlerContainer.querySelector('.tc-tiddler-body.tc-clearfix.tc-reveal');
            if (!bodyElement) {
                attempts++;
                if (attempts < maxAttempts) {
                    await new Promise(resolve => setTimeout(resolve, 100));
            ...
            // Get all direct children of the body element
            ...
            if (elementIndex < children.length) {
                const targetElement = children[elementIndex];
                ...
                console.warn("Element index out of range:", elementIndex, "children count:", children.length);
                return;
            }
        }
    }
